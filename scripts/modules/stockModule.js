(function (ng, window) {
    ng.module("stockModule", ["stockApiModule"])
        .controller("StockItemDetailController", ["$scope", "$state", "$stateParams", "StockServicesApi", StockItemDetailController])
    ...
    function StockItemDetailController(scope, $state, $stateParams, StockServiceApi) {
